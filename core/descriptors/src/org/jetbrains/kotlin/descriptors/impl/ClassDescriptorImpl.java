...
public class ClassDescriptorImpl extends ClassDescriptorBase {
    ...
    public final void initialize(
        ...
        // Force evaluation of supertypes, otherwise supertypes may be computed later from other thread,
        // which is non-thread safe because we're using LockBasedStorageManager.NO_LOCKS
